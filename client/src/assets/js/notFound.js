...
//         if (colors[pixelPosition] > 200 && (colors[pixelPosition + 1]) > 200 && (colors[
//             pixelPosition + 2]) > 200 || colors[pixelPosition + 3] === 0) {
//           continue;
//         }

//         var color = 'rgba(' + colors[pixelPosition] + ',' + colors[pixelPosition + 1] + ',' +
//           colors[pixelPosition + 2] + ',' + '1)';
//         this.points.push({
//           x: j,
//           y: i,
//           originalX: j,
...
//       if (this.mouse.down) {
//         distance = this.reactionSensitivity * 200 / Math.sqrt((this.mouse.x - currentPoint.x) *
//           (this.mouse.x - currentPoint.x) +
//           (this.mouse.y - currentPoint.y) * (this.mouse.y - currentPoint.y));
//       } else {
//         distance = this.reactionSensitivity * 100 / Math.sqrt((this.mouse.x - currentPoint.x) *
//           (this.mouse.x - currentPoint.x) +
//           (this.mouse.y - currentPoint.y) * (this.mouse.y - currentPoint.y));
//       }


//       currentPoint.x += Math.cos(theta) * distance + (currentPoint.originalX - currentPoint.x) *
//         0.05;
//       currentPoint.y += Math.sin(theta) * distance + (currentPoint.originalY - currentPoint.y) *
//         0.05;
...
//           this.context.lineWidth = (1 - (distance / this.drawDistance)) * this
//             .maxLineThickness * this.lineThickness;
...
//     if (this.bgImage.width > this.bgCanvas.width - 100 || this.bgImage.height > this.bgCanvas
//       .height - 100) {

//       var maxRatio = Math.max(this.bgImage.width / (this.bgCanvas.width - 100), this.bgImage
//         .height / (this.bgCanvas.height - 100));
...
//     this.bgContext.drawImage(this.bgImage, (this.canvas.width - newWidth) / 2, (this.canvas.height -
//       newHeight) / 2, newWidth, newHeight);
//     this.bgContextPixelData = this.bgContext.getImageData(0, 0, this.bgCanvas.width, this.bgCanvas
//       .height);
